...
Cal.prototype.showMonth = function(y, m) {
  ...
  var html = '<table class="table shadow">';
  ...
  do {
    ...
    // it will write the last days from the previous month
      ...
      for(var j=0; j < firstDayOfMonth; j++) {
        html += '<td><a role="button" class="btn btn-success disabled" data-toggle="modal" href="#exampleModalCenter"><table><tr><td class="daysNumber">'+ k + '</td></tr>' + mostrarEventos(this.currYear,this.currMonth,i,eventos) + '</a></td>';
        k++;
      }
    }
